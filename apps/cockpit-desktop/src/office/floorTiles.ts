...
/** Enable or disable colorization for loaded floor sprites. */
export function setFloorColorizeEnabled(enabled: boolean): void {
  floorColorizeEnabled = enabled
  clearColorizeCache()
}
