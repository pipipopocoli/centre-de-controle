...
/** Enable or disable colorization for loaded wall sprites. */
export function setWallColorizeEnabled(enabled: boolean): void {
  wallColorizeEnabled = enabled
}
