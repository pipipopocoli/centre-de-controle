...
- /Users/oliviercloutier/Desktop/Cockpit/docs/swarm_results/wave20r_a11_backlog.md
...
5) Work rules
- Mission focus: Python cloud API parity (llm-profile, roadmap draft)
...
6) Validation gates
- python3 -m py_compile server/contracts.py server/main.py server/config.py
- python3 tests/verify_cloud_api_websocket_events.py

7) Deliverables
- Update: /Users/oliviercloutier/Desktop/Cockpit/docs/swarm_results/wave20r_a11_backlog.md
- Fill report: /Users/oliviercloutier/Desktop/Cockpit/docs/swarm_results/wave20r_agent11_report.md
