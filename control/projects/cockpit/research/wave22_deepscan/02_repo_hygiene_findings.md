# Wave22 Repo Hygiene Findings

## Top Debt Buckets

### control_project / stale_api_refs (80)
...
### control_project / legacy_runtime (80)
...
### control_project / legacy_naming (80)
...
### control_project / debt_markers (80)
...
### python_server / stale_api_refs (4)
...
### python_server / legacy_runtime (1)
- `server/repository.py:324` - risks=["Legacy local-file drift"],

### python_app / stale_api_refs (1)
- `app/services/cloud_api_client.py:135` - f"/v1/projects/{urllib.parse.quote(project_id, safe='')}/chat/agentic-turn",

## Broken Local Markdown Links

- `control/projects/cockpit/issues/ISSUE-CP-0034-wave07-ui-polish.md` -> `../../missions/MISSION-LEO-WAVE07.md`
- `control/projects/cockpit/issues/ISSUE-CP-0034-wave07-ui-polish.md` -> `../../../../docs/reports/CP01_UI_WAVE07_EVIDENCE.md`
- `control/projects/cockpit/issues/ISSUE-CP-0014-ui-fail-open-network-down-states.md` -> `/Users/oliviercloutier/Desktop/Cockpit/docs/reports/CP01_SLO_COST_EVIDENCE_2026-02-19.md`
