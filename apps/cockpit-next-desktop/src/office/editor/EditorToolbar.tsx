...
function getInitialCategory(): FurnitureCategory {
  return getActiveCategories()[0]?.id ?? 'desks'
}
...
export function EditorToolbar({
  ...
  const [activeCategory, setActiveCategory] = useState<FurnitureCategory>(() => getInitialCategory())
  ...
  const effectiveCategory: FurnitureCategory =
    activeCategories.find((cat) => cat.id === activeCategory)?.id ??
